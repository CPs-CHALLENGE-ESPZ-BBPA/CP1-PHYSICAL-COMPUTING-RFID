...
try:
    ...
    ser = serial.Serial('COM5', 9600, timeout=0.1)  # Alterar a porta de acordo com o seu dispositivo
    arduino_conectado = True
...
ALUNOS_REGISTRADOS = {
    ...
    "BD:84:7A:59": {"nome": "Ronaldo", "exercicio": "Triceps", "objetivo": 10},
    "D6:EE:4C:1F": {"nome": "Messi", "exercicio": "Triceps", "objetivo": 10},
}
...
while cap.isOpened():
    ...
    if estado_app == "AGUARDANDO_ID":
        ...
        if resultado.pose_landmarks:
            ...
            # --- Adicione estas linhas logo após o cálculo do angulo (aprox. linha 105) ---

            # Converte o ângulo para texto com uma casa decimal
            texto_angulo = f"{int(angulo)} graus"

            # Correção: subtraímos 50 de cotovelo[0] para mover no eixo X (esquerda)
            ...
            if angulo > 50: estagio_exercicio = "descida"
